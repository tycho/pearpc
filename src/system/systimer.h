...
#define SYS_GET_TIME_STRING_BUF 13

/**
 * Create current time stamp string in form HH:MM:SS.XXX.
 *
 * @param str_buf Buffer to place timestamp string.
 * Size of buffer must be at least SYS_GET_TIME_STRING_BUF chars.
 */
