...
static UInt8 bswabU8_inc(char **ptr)
{
	UInt8 v = *(UInt8 *)*ptr;
	*ptr += 1;
	return v;
...
static UInt16 bswabU16_inc(char **ptr)
{
	UInt16 v = *(UInt16 *)*ptr;
	*ptr += 2;
	return bswap_16(v);
...
static UInt32 bswabU32_inc(char **ptr)
{
	UInt32 v = *(UInt32 *)*ptr;
	*ptr += 4;
	return bswap_32(v);
...
static APPLEUInt64 bswabU64_inc(char **ptr)
{
...
static void bstoreU8_inc(char **ptr, UInt8 val)
{
	UInt8 **p = (UInt8 **)ptr;
	**p = val;
	*ptr += 1;
...
static void bstoreU16_inc(char **ptr, UInt16 val)
{
	UInt16 **p = (UInt16 **)ptr;
	**p = bswap_16(val);
	*ptr += 2;
...
static void bstoreU32_inc(char **ptr, UInt32 val)
{
	UInt32 **p = (UInt32 **)ptr;
	**p = bswap_32(val);
	*ptr += 4;
...
static void bstoreU64_inc(char **ptr, APPLEUInt64 val)
{
